  ...
  <head>
    ...
    <script type="text/javascript">
      $(function(){
          ...
          if( i==_i)
          {
          $('.banner .button a.btn'+i).addClass('index');
          }
          else
          {
            $('.banner .button a.btn'+i).removeClass('index');
          }		
          $('#shows'+i).stop().animate({'left':  ((i-_i)*w)+'px' },0,function(){$(this).show();});
          }		
          }
      ...
      function graph1(){
        ...
        if (res_objects1=="error"){
          ...
          if(res_objects1=='No_data'){
            $(document).ready(function(){
                if($(".btn1").hasClass("index")){
                $(".btn1").removeClass("index");
                $(".btn2").addClass("index");
                }
                $(".btn1").remove();
                });
...
function graph2(){
  ...
  if (res_objects2=="error"){
    ...
    //window.alert(length);
    if(res_objects2=='No_data'){
      $(document).ready(function(){
          if($(".btn2").hasClass("index")){
          $(".btn2").removeClass("index");
          $(".btn3").addClass("index");
          }
          $(".btn2").remove();
          });
...
function graph3(){
  ...
  if (res_objects3=="error"){
    ...
    if(res_objects3=='No_data'){
      $(document).ready(function(){
          if($(".btn3").hasClass("index")){
          $(".btn3").removeClass("index");
          $(".btn4").addClass("index");
          }
          $(".btn3").remove();
          });
...
for(var i=1;i<5;i++){
  if( $('.banner .button a.btn'+i).hasClass('index')){
    //window.alert(i);
    changeBanner(i);
  }
}
...
function chuli(){
  if (myXmlHttpRequest.readyState==4 && myXmlHttpRequest.status==200) {
    ...
    getId('Injection_time').innerHTML=res_objects.Sample_rlt.Injection_time;
    getId('Run_id').innerHTML=res_objects.Sample_rlt.Run_id;
    getId('Run_type').innerHTML=res_objects.Sample_rlt.Run_type;
    getId('Calibration_level').innerHTML=res_objects.Sample_rlt.Calibration_level;
    getId('Sample_stream').innerHTML=res_objects.Sample_rlt.Sample_stream;
    getId('Alarms').innerHTML=res_objects.Sample_rlt.Alarms;

    getId('Active_method').innerHTML=res_objects.Energy_meter.Active_method;
    getId('Compressibility_air_unit').innerHTML=res_objects.Energy_meter.Compressibility_air.Unit;
    getId('Compressibility_air_value').innerHTML=res_objects.Energy_meter.Compressibility_air.Value;

    getId('Ref_temp_unit').innerHTML=res_objects.Energy_meter.Ref_temp.Unit;
    getId('Ref_temp_value').innerHTML=res_objects.Energy_meter.Ref_temp.Value;

    getId('Compressibility_unit').innerHTML=res_objects.Energy_meter.Compressibility.unit;
    getId('Compressibility_value').innerHTML=res_objects.Energy_meter.Compressibility.Value;

    getId('Molar_mass_unit').innerHTML=res_objects.Energy_meter.Molar_mass.Unit;
    getId('Molar_mass_value').innerHTML=res_objects.Energy_meter.Molar_mass.Value;

    getId('Molar_mass_ratio_unit').innerHTML=res_objects.Energy_meter.Molar_mass_ratio.Unit;
    getId('Molar_mass_ratio_value').innerHTML=res_objects.Energy_meter.Molar_mass_ratio.Value;

    getId('Rel_density_unit').innerHTML=res_objects.Energy_meter.Rel_density.Unit;
    getId('Rel_density_value').innerHTML=res_objects.Energy_meter.Rel_density.Value;

    getId('Abs_density_unit').innerHTML=res_objects.Energy_meter.Abs_density.Unit;
    getId('Abs_density_value').innerHTML=res_objects.Energy_meter.Abs_density.Value;

    getId('Hs_unit').innerHTML=res_objects.Energy_meter.Hs.Unit;
    getId('Hs_value').innerHTML=res_objects.Energy_meter.Hs.Value;

    getId('Hi_unit').innerHTML=res_objects.Energy_meter.Hi.Unit;
    getId('Hi_value').innerHTML=res_objects.Energy_meter.Hi.Value;

    getId('Wobbe_sup_unit').innerHTML=res_objects.Energy_meter.Wobbe_sup.Unit;
    getId('Wobbe_sup_value').innerHTML=res_objects.Energy_meter.Wobbe_sup.Value;

    getId('Wobbe_inf_unit').innerHTML=res_objects.Energy_meter.Wobbe_inf.Unit;
    getId('Wobbe_inf_value').innerHTML=res_objects.Energy_meter.Wobbe_inf.Value;

    var num=res_objects.Application_rlt.Size;
    ...
    for(var i=0;i<=num-1;i++){
      ...
      mytd1.innerHTML=res_objects.Application_rlt.Components[i].Name;
      mytd2.innerHTML=res_objects.Application_rlt.Components[i].ESTD;
      mytd3.innerHTML=res_objects.Application_rlt.Components[i].Norm;
      mytd4.innerHTML=res_objects.Application_rlt.Components[i].Weight;
...
<body>   
  <div class="banner">
    <div class="button">
      <a href="javascript:void(0)" class="btn1 index">1</a>
      <a href="javascript:void(0)" class="btn2">2</a>
      <a href="javascript:void(0)" class="btn3">3</a>
      <a href="javascript:void(0)" class="btn4">4</a>
      <div class="clear"></div>
    </div>
    <div class="showf" id="showf">
      <div class="shows" id="shows1">
        <div id="graph1"></div>
      </div>
      <div class="shows" id="shows2">
        <div id="graph2"></div>
      </div>
      <div class="shows" id="shows3">
        <div id="graph3"></div>
      </div>
      <div class="shows" id="shows4">
        <div id="graph4"></div>
      </div>
      <div class="clear"></div>
    </div>
